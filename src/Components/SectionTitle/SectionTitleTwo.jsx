...
const SectionTitleTwo = ({ heading, subHeading }) => {
    return (
        <div>
            <div className="md:w-4/12 mx-auto text-center my-8 bg-black bg-opacity-50 rounded-xl">
                ...
                <h3 className=" text-3xl font-bold text-orange-400 border-gray-300 border-b-2 pb-2">{heading}</h3>
