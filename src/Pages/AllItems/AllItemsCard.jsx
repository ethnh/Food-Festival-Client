    ...
    return (
        <div>
            <div className="card card-compact w-80 bg-base-100 shadow-2xl">
                ...
                <div className="badge  bg-black bg-opacity-70 p-3 font-bold  text-white absolute right-0 mr-4 mt-4 "><span>% off</span></div>
                <div className="card-body flex-col">
                    ...
                    <p className="flex items-center gap-2"><HiOutlineCheckBadge className="text-xl text-red-400" /></p>
                    <p className="flex items-center gap-2"><HiOutlineCheckBadge className="text-xl text-red-400" /></p>
                    <hr />
