const Footer = () => {
    return (
        <div>
            ...
            <footer className="footer justify-evenly px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Ishti Industries Ltd. <br />Providing reliable tech since 2022</p>
                </aside>
